...
class RRE_GNN(torch.nn.Module):
    def __init__(self, params, loader):
        super(RRE_GNN, self).__init__()
    ...
    def forward(self, subs, rels, mode='train'):
        ...
        # non_visited entities have 0 scores
        if torch.cuda.is_available():
...
class IdentityLayer(torch.nn.Module):
    ...
    def forward(self, q_sub, q_rel, hidden, edges, n_node, old_nodes_new_idx):
        # edges:  [batch_idx, head, rela, tail, head_new_idx, tail_new_idx]
